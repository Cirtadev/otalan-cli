...
export function printHelp(version: string, options: { includeNotes?: boolean } = {}) {
  const commands = [
    ...
    ['bundles', '[--platform ios|android] [--page 1]', 'List published bundles for a release tuple.'],
    ['', '[--channel production] [--runtime-version 1.0.0] [--page-size 20]', ''],
    ['rollback', '--bundle-id ... [--platform ios|android] [--page 1]', 'Reactivate a published bundle.'],
    ['', '[--channel production] [--runtime-version 1.0.0] [--page-size 20]', ''],
